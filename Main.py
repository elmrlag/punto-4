...
if __name__ == '__main__':
    ...
    print("solamente la hora")
    r.PonerEnHora(5) # solamente la hora
    r.Mostrar()

    print("hora y minutos")
    r.PonerEnHora(13,30) #hora y minutos
    r.Mostrar()

    print("hora, minutos y segundos")
    r.PonerEnHora(14, 30, 25) #hora, minutos y segundos
    r.Mostrar()

    print("sumar 3 horas a la hora actual")
    r2.AdelantarHora(3) #sumar 3 horas a la hora actual
    r2.Mostrar()

    print("sumar 1 hora y 15 minutos a la hora actual")
